          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-health-green-600 rounded-full flex items-center justify-center hover:bg-health-green-700 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {footerLinks.services.map((link, index) => (
                  <li key={index}>
                    <a href="#" className="text-gray-300 hover:text-health-green-400 transition-colors">
                      {link}
                    </a>
                  </li>
                ))}
            ...
            <div>
              ...
              <div className="mt-8">
                <h4 className="text-sm font-semibold text-gray-400 mb-3">CONTACT DIRECT</h4>
                <div className="space-y-2 text-sm">
                  <p className="text-gray-300">+241 76364087</p>
                  <p className="text-gray-300">Réseausanté+infos@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              <a href="#" className="text-gray-400 hover:text-health-green-400 transition-colors">
                Mentions légales
              </a>
              <a href="#" className="text-gray-400 hover:text-health-green-400 transition-colors">
