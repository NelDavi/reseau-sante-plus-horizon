...
const AboutSection = () => {
  return (
    <section id="qui-sommes-nous" className="py-20 gradient-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-trust-blue-700 max-w-3xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="animate-slide-in">
            <h3 className="text-2xl font-bold text-trust-blue-900 mb-6">
              Notre Histoire
            </h3>
            <p className="text-trust-blue-700 leading-relaxed mb-6">
            ...
            <p className="text-trust-blue-700 leading-relaxed">
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-trust-blue-900 mb-2">
                  3 Courtiers Fondateurs
                </h4>
                <p className="text-trust-blue-600">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg text-center animate-fade-in">
            <div className="w-16 h-16 gradient-medical rounded-full flex items-center justify-center mx-auto mb-6">
              <Target className="h-8 w-8 text-white" />
            </div>
            <h3 className="text-xl font-bold text-trust-blue-900 mb-4">Notre Mission</h3>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg text-center animate-fade-in">
            ...
            <h3 className="text-xl font-bold text-trust-blue-900 mb-4">Notre Vision</h3>
            <p className="text-trust-blue-600 leading-relaxed">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg text-center animate-fade-in">
            ...
            <h3 className="text-xl font-bold text-trust-blue-900 mb-4">Nos Valeurs</h3>
            <div className="space-y-3">
              <div className="flex items-center justify-center space-x-2">
                <div className="w-2 h-2 bg-medical-blue-600 rounded-full"></div>
                <span className="text-trust-blue-700 font-medium">Proximité</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
                <div className="w-2 h-2 bg-accent-teal-600 rounded-full"></div>
                <span className="text-trust-blue-700 font-medium">Innovation</span>
              </div>
            </div>
          </div>
        </div>
