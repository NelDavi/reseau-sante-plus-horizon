...
const PartnersSection = () => {
  ...
  return (
    <section id="partenaires" className="py-20 gradient-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Insurance Partners */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-center text-trust-blue-900 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {insurancePartners.map((partner, index) => (
              <div key={index} className="bg-white rounded-xl p-8 shadow-lg text-center animate-slide-in">
                <div className="w-20 h-20 gradient-medical rounded-full flex items-center justify-center mx-auto mb-6">
                  <span className="text-white font-bold text-lg">{partner.name[0]}</span>
                </div>
                <h4 className="text-xl font-bold text-trust-blue-900 mb-3">
                  {partner.name}
                </h4>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {healthCategories.map((category, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg text-center animate-fade-in">
                ...
                <h4 className="text-lg font-semibold text-trust-blue-900 mb-3">
                  {category.title}
                </h4>
                <p className="text-trust-blue-600 text-sm">
        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold text-trust-blue-900 mb-6">
                Pourquoi devenir partenaire ?
              </h3>
              
              <div className="space-y-4 mb-8">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-medical-blue-600 rounded-full mt-2 flex-shrink-0"></div>
            ...
            <div className="relative">
              <div className="gradient-medical rounded-xl p-8 text-white text-center">
                ...
                <div className="text-medical-blue-200">Partenaires déjà engagés</div>
              </div>
            </div>
          </div>
        </div>
